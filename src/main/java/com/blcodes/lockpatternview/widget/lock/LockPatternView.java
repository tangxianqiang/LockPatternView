...
public class LockPatternView extends View {
    ...
    private void startCellStateAnimationHw(final CellState cellState,
        ...
        cellState.hwCenterY = getCenterYForRow(cellState.row) + startTranslationY;
        cellState.hwCenterX = getCenterXForColumn(cellState.col);
        cellState.hwRadius = mDotSize/2 * startScale;
        mPaint.setColor(getCurrentColor(false));
        mPaint.setAlpha((int) (startAlpha * 255));
        cellState.hwPaint = new Paint(mPaint);
...
//        ValueAnimator animator = ValueAnimator(cellState.hwPaint,
...
//        animator.start();
    ...
    private void startRtFloatAnimation(float property, float endValue,
            long delay, long duration, Interpolator interpolator) {
        ValueAnimator animator = ValueAnimator.ofFloat(property, endValue);
        animator.setDuration(duration);
        animator.setStartDelay(delay);
        animator.setInterpolator(interpolator);
        animator.setTarget(this);
...
//        if (AccessibilityManager.isAccessibilityButtonSupported().getInstance(getContext()).isTouchExplorationEnabled()) {
...
//        }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        byte[] patternBytes = patternToByteArray(mPattern);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setPattern(
                DisplayMode.Correct,
                byteArrayToPattern(ss.getSerializedPattern().getBytes()));
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        @Override
        protected void getVisibleVirtualViews(ArrayList<Integer> virtualViewIds) {
