...
public class LockscreenCredential implements Parcelable, AutoCloseable {
    ...
    public static final int CRYPT_TYPE_PASSWORD = PASSWORD_TYPE_PASSWORD;
    /** @hide */
    public static final int CRYPT_TYPE_DEFAULT = PASSWORD_TYPE_DEFAULT;
    /** @hide */
    public static final int CRYPT_TYPE_PATTERN = PASSWORD_TYPE_PATTERN;
    /** @hide */
    public static final int CRYPT_TYPE_PIN = PASSWORD_TYPE_PIN;
    ...
    public void checkLength() {
        ...
        if (isPassword() || isPin()) {
            if (size() < MIN_LOCK_PASSWORD_SIZE) {
    ...
    public static final Creator<LockscreenCredential> CREATOR =
            new Creator<LockscreenCredential>() {
